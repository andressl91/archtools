...
INSTALL_PATH=/opt/crossarm64/${TARGET}
USE_NEWLIB=0
LINUX_ARCH=arm64
...
ARCHLINUX_ARM=ArchLinuxARM-rpi-3-latest
#wget -nc http://os.archlinuxarm.org/os/${ARCHLINUX_ARM}.tar.gz
#mkdir $INSTALL_PATH/$TARGET
bsdtar -zxvf ${ARCHLINUX_ARM}.tar.gz -C $INSTALL_PATH/$TARGET
...
../${GLIBC_VERSION}/configure \
                ...
                --host=$TARGET \
                --target=$TARGET \
                --with-headers=$INSTALL_PATH/$TARGET/usr/include \
                --disable-multilib \
